...
def evaluate(p, C, I_pot_eV, betaStar, sGarland=False, return_components=False):
    """
    ...
    if sGarland:
        ...
        S = 1/(1+(5*5.11*e/(E*mc2*1e-5)) * np.exp(-E*mc2/e*1e-5))

    sigma = (1-S)*sigmaNR + S*sigmaR

    if return_components:
        return sigma, sigmaNR, sigmaR
    else:
        return sigma
